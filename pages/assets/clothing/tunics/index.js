      ...
      <section className='py-20'>
         <article className="w-4/5 mx-auto h-full">
            <div className='flex content-center'>
               <BreadCrumb category={"clothing"} sub={"tunics"} />
            ...
            <IndexTitle title={"tunics"} />
            <ul className='grid grid-cols-6 gap-6'>
               {
                  tunics.slice(0, 25).filter(tunics => tunics.fields.title.toLowerCase().includes(filterParam.toLowerCase())).map(asset => (
