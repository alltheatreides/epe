...
export async function getStaticProps() {
   ...
   const res = await client.getEntries({ content_type: "asset", 'fields.categories': 'armors' })
...
const Armors = ({ armors }) => {
   ...
   return (
      <AssetCategoryIndex
         breadCrumbCategory1={armors[0].fields.categories[0]}
         breadCrumbCategory2={armors[0].fields.categories[1]}
