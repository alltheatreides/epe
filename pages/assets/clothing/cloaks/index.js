      ...
      <section className='py-20'>
         <article className="w-4/5 mx-auto h-full">
            <div className='flex content-center'>
               <BreadCrumb category={"clothing"} sub={"cloaks"} />
            ...
            <IndexTitle title={"cloaks"} />
            <ul className='grid grid-cols-6 gap-6'>
               {
                  cloaks.slice(0, 25).filter(cloaks => cloaks.fields.title.toLowerCase().includes(filterParam.toLowerCase())).map(asset => (
