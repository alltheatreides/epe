      ...
      <section className='py-20'>
         <article className="w-4/5 mx-auto h-full">
            <div className='flex content-center'>
               <BreadCrumb category={"ethnicities"} sub={"africa"} />
            ...
            <h1 className="text-5xl uppercase tracking-[.25rem] lg:w-3/12 mt-4 mb-8">africa</h1>
            <ul className='grid grid-cols-6 gap-6'>
               {
                  africa.slice(0, 25).filter(africa => africa.fields.title.toLowerCase().includes(filterParam.toLowerCase())).map(asset => (
